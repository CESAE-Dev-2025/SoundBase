...
@section('content')
    ...
    <div class="row">
        ...
        <img
            src="{{ $band->photo ? asset('storage/' . $band->photo) : asset('images/Profile_avatar_placeholder_large.png') }}"
            alt="Imagem da banda" class="col-4">

        <div class="col-8">
            @auth
                <form method="post" action="{{ route('bands.update') }}" class="mb-5"
    ...
    <p class="my-3"><a class="btn btn-primary" href="{{ route('bands.detail', $band->id) }}">Mais informações</a></p>
    <hr>
    <h3 class="my-3">Álbums</h3>
